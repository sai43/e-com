...
ActiveRecord::Schema.define(version: 2019_04_24_134917) do
  ...
  create_table "friendly_id_slugs", force: :cascade do |t|
    ...
    t.index ["slug", "sluggable_type", "sequence", "scope"], name: "index_slugs_on_n_s_s_and_s", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "user_type", default: "advanced"
